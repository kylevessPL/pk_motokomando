...
public class BaseView {
    ...
    private void addContent() {
        ...
        tab_find_doctor.setContent(anchorPane);
        ...
        tab_add_new_doctor.setContent(anchorPane0);
        ...
        tab_find_patient.setContent(anchorPane1);
        ...
        tab_add_new_patient.setContent(anchorPane2);
        ...
        anchorPane.getChildren().add(tableView_doctors);
        tabPane_doctors.getTabs().add(tab_find_doctor);
        anchorPane0.getChildren().add(textField_new_doctor_name);
        anchorPane0.getChildren().add(button_add_new_doctor);
        anchorPane0.getChildren().add(textField_new_doctor_surname);
        anchorPane0.getChildren().add(textField_new_doctor_phone_number);
        anchorPane0.getChildren().add(choiceBox_doctor_specialisations);
        anchorPane0.getChildren().add(label_new_doctor_specialisation);
        ...
        anchorPane1.getChildren().add(tableView_patients);
        tabPane_patients.getTabs().add(tab_find_patient);
        anchorPane2.getChildren().add(textField_new_patient_name);
        anchorPane2.getChildren().add(textField_new_patient_surname);
        anchorPane2.getChildren().add(datePicker_new_patient_birthday);
        anchorPane2.getChildren().add(choiceBox_new_patient_sex);
        anchorPane2.getChildren().add(choiceBox_new_patient_blood_group);
        anchorPane2.getChildren().add(textField_new_patient_street);
        anchorPane2.getChildren().add(textField_new_patient_house_number);
        anchorPane2.getChildren().add(textField_new_patient_zip_code);
        anchorPane2.getChildren().add(textField_new_patient_city);
        anchorPane2.getChildren().add(choiceBox_new_patient_id_type);
        anchorPane2.getChildren().add(textField_new_patient_id_number);
        anchorPane2.getChildren().add(textField_new_patient_phone_number);
        anchorPane2.getChildren().add(button_add_new_patient);
        anchorPane2.getChildren().add(label_new_patient_sex);
        anchorPane2.getChildren().add(label_new_patient_blood_group);
        anchorPane2.getChildren().add(label_new_patient_id_type);
